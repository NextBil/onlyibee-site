...
(function(){
  ...
  function heartbeat(){var id=visitor(),path=location.pathname;return call("record_site_visit",{visitor_id:id,page_path:path,country_code:""}).then(function(result){return country().then(function(c){return c?call("record_site_visit",{visitor_id:id,page_path:path,country_code:c}):result;}).catch(function(){return result;});});}
